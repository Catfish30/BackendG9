...
class RecetaIngredienteModel(base_de_datos.Model):
    ...
    recetaIngredienteId = Column(type_=types.Integer,primary_key=True,nullable=False,autoincrement=True,name='id')

    recetaIngredienteCantidad = Column(name='cantidad', type_=types.String(length=20), nullable=False) #recien agregado
